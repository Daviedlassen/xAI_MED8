          ...
          >
            ...
            {!singleThreshold && (
              ...
              >
                ...
                <div style={{ position: "absolute", top: 3, left: "50%", transform: "translateX(-50%)", fontSize: 9, fontWeight: 800, background: "rgba(255,255,255,0.92)", padding: "0 2px", borderRadius: 2, whiteSpace: "nowrap", pointerEvents: "none" }}>
                  {low}
                </div>
              </div>
            )}
...
const InteractableVariables = ({ patientData, thresholds, onChange, activeCategory }) => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0 }}>
      <div className="panel-title">Changeable variables</div>
